...
${JAVA_HOME}/bin/java -classpath ${CLASSPATH} com.crossover.trial.weather.WeatherServer &
SERVER_PID=$$
...
${JAVA_HOME}/bin/java -classpath ${CLASSPATH} com.crossover.trial.weather.WeatherClient
CLIENT_PID=$$
cleanup
